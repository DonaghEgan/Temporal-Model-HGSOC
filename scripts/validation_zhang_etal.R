...
load("inputs/EGAD00010001515.RData")
...
zhang_meta <- read_xlsx("inputs/zhang_meta.xlsx", sheet = 2)

# Load differentially expressed proteins
result_dep <- readRDS("outputs/DEP_infiltrated.Rds")
...
pdf("outputs/zhang_cluster_inf_genes.pdf")
...
pdf("outputs/zhang_cluster_ex_genes.pdf")
...
# Load metadata
zhang_meta <- read_xlsx("inputs/zhang_meta.xlsx", sheet = 8)
...
pdf("outputs/zhang_inf_signature_immune_metrics.pdf")
