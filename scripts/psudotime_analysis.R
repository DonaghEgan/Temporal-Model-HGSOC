...
input_data_path <- "/mnt/8TB/Projects/POIAZ/Donagh/protypia_proteomics/outputs/imputed_data.Rds"
plex_info_path <- "/mnt/8TB/Projects/POIAZ/Donagh/protypia_proteomics/outputs/plex_info.Rds"
gene_meta_path <- "/mnt/8TB/Projects/POIAZ/Donagh/protypia_proteomics/outputs/gene_meta.Rds"
phenopath_fit_path <- "/mnt/8TB/Projects/POIAZ/Donagh/protypia_proteomics/inputs/phenopath_fit.Rds"

# Load proteomics data
if (!file.exists(input_data_path) || !file.exists(plex_info_path) || !file.exists(gene_meta_path)) {
...
pdf("/mnt/8TB/Projects/POIAZ/Donagh/protypia_proteomics/outputs/pseudotime_mets.pdf", height = 3, width = 3)
...
pdf("/mnt/8TB/Projects/POIAZ/Donagh/protypia_proteomics/outputs/pseudotime_sitegrouped.pdf", height = 4, width = 4)
...
# Plot
pdf("/mnt/8TB/Projects/POIAZ/Donagh/protypia_proteomics/outputs/correlations_variable_pseudotime.pdf", height = 2.3, width = 4)
